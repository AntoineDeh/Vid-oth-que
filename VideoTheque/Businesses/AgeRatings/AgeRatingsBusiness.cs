...
namespace VideoTheque.Businesses.AgeRatings
{
    public class AgeRatingsBusiness : IAgeRatingsBusiness
    {
        ...
        public AgeRatingDto GetAgeRating(int id)
        {
            ...
            {
                throw new NotFoundException($"Limite d'âge '{id}' non trouvé");
            }
            return ageRating;
        }
        ...
        public AgeRatingDto InsertAgeRating(AgeRatingDto ageRating)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de l'insertion de la limitation d'âge {ageRating.Name}");
            }
        ...
        public void UpdateAgeRating(int id, AgeRatingDto ageRating)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la modification de la limitation d'âge {ageRating.Name}");
            }
        }
        ...
        public void DeleteAgeRating(int id)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la suppression de la limitation d'âge");
            }
        }
    }
}
